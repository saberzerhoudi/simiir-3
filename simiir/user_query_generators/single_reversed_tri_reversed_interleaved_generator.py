...
from simiir.user_query_generators.single_term_generator_reversed import SingleTermQueryGeneratorReversed
from simiir.user_query_generators.tri_term_generator_reversed import TriTermQueryGeneratorReversed
