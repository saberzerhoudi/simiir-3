...
class TopicBasedLMTextClassifier(LMTextClassifier):
    ...
    """
    def __init__(self, topic, user_context, stopword_file=[], background_file=[], topic_weighting=1, topic_background_weighting=1, document_weighting=1):
        ...
        super(TopicBasedLMTextClassifier, self).__init__(topic, user_context, stopword_file, background_file)
