...
class SimulatedUser(object):
    ...
    def __do_action(self, action):
        ...
        self.__user_context.set_action(action)
    ...
    def __do_decide(self):
        ...
        """
        current_serp_length = self.__user_context.get_current_results_length()
        current_serp_position = self.__user_context.get_current_serp_position() + 1
